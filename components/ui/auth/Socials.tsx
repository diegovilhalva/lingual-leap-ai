...
const Socials = ({ loading, setLoading }: Props) => {
    ...
    const handleLogin = async ({ provider }: { provider: GithubAuthProvider | GoogleAuthProvider }) => {
        setLoading(true)
        await signInWithPopup(auth, provider)
            ...
            .catch((error) => {
                const providerName = provider instanceof GithubAuthProvider ? "GitHub" : "Google";
